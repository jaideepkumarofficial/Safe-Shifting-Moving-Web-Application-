...
<link rel="stylesheet" href="Home1.css" media="screen">
  ...
  <form id="form" method="post" action="DelTruck.jsp" class="form-horizontal">
    ...
    <section class="u-clearfix u-section-1" id="sec-6bf6">
      <div class="u-clearfix u-sheet u-sheet-1">
	   ...
	   <p style="font-size:28px;text-align:center;">Delete Truck here</p>
     ...
     <table class="center" style=" margin-left:38%; border-collapse:separate; border-spacing:0px 30px;">
    	...
    	<tr>
    		...
    		<td>
                        <Button class="btn btn-success" style="width: 80px;height:35px;line-height:0.2;">Search</Button>    
    		</td>
    	</tr>
    			...
    			<input style="background-color: SteelBlue;  border: none; color: white;  padding: 8px;text-align: center;font-size: 16px;  margin: 1px 1px;  opacity: 1;  transition: 0.3s;  border-radius: 25px;  width:120px;" type="submit" value="Delete" onclick="form.action='DelTruck';" class="btn"/>
    			</div>
    </form>
    <div class="container">
            <div class="form-group col-12 p-0">
             <%
                ...
                out.print("<br><br><br>");
                 ...
                 pst = con.prepareStatement("select * from truckdetail where tno =?");
                 pst.setString(1, tno);
                 rs = pst.executeQuery();
                  if(rs.next())
                  {   
                	  out.print("<center><h3>Truck Details</h3></center>");
                	  out.print("<br>");
                      ...
                      out.print("<TD>" + "Truck Number" + "<TD>");
                      out.print("<TD>" + "Driver Name" + "<TD>");
                      out.print("<TD>" + "Chassis Number" + "<TD>");
                      
                      out.print("</TR></center>");
                	  out.print("<TR>");
                      out.print("<TD>" + rs.getString("ttype") + "<TD>");
                  ...
                  else
                  {
                	  out.print("<center><h3>Truck Details</h3></center>");
                	  out.print("<br>");
                	  out.print("<center><Table border=1 bgcolor=lightgray cellpadding=2 border-spacing=15 cellspacing=2 width=1000>");
                	  out.print("<TR>");
                      out.print("<TD>" + "Truck Type" + "<TD>");
                      out.print("<TD>" + "Truck Number" + "<TD>");
                      out.print("<TD>" + "Driver Name" + "<TD>");
                      ...
                      out.print("</TR>");
                      out.print("</Table></center>");
                      out.print("<center><p>No Data Found</p></center>");
                  }
