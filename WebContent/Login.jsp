...
<form  action="http://localhost:8080/SafeShifting/Login">
	...
	c-0.252,0.137-0.502,0.297-0.752,0.476C5.276,41.792,2,35.022,2,27.5z"></path></svg>
              ...
              <p style="color:gray;font-size:20px;">Login/Signup</p>
              <table>
              	<tr>
              		<td ><br>
              	...
              	<tr style="line-height:0.2">
              		<td>
              			<input style="width:200px;text-align:center;color:gray; border-radius:15px; border: 1px solid lightgray;height:30px; margin-left:18%;"type="text" name="mobile" pattern="[789][0-9]{9}" required/><br/><br><br><br><br><br><br><br><br>
              		</td>
              	</tr>
              	<tr>
