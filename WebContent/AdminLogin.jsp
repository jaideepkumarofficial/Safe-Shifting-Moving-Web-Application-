...
<form method="post" action="http://localhost:8080/SafeShifting/AdminLogin">
	...
	c-0.252,0.137-0.502,0.297-0.752,0.476C5.276,41.792,2,35.022,2,27.5z"></path></svg>
              ...
              <table>
              	<tr>
              		<p style="line-height:0.02;font-size:18px;text-align:left;margin-left:28%;">Admin Id.</p>
              	</tr>
              	
              	<tr style="line-height:0.2">
              		<input style="width:200px; margin-left:18%;"type="text" name="id" required/><br/>
              	...
              	<tr style="line-height:0.2">
              		<input style="width:200px; margin-left:18%;"type="password" name="password"  required/><br/>
              	</tr>
              	<tr>
              	<td></td>
              	</tr>
